function googleTranslateEl() {
    ...
    $('#google_translate_element').on("click", function () {
        ...
        $("iframe").contents().find('.goog-te-menu2 span:contains(English)')
            .before('<img src="lang/en.png" alt="" style="width: 20px; height: 20px" />').text('EN');
        $("iframe").contents().find('.goog-te-menu2 span:contains(Uzbek)')
            .before('<img src="lang/uz.png" alt="" style="width: 20px; height: 15px" />').text('UZ');
        $("iframe").contents().find('.goog-te-menu2 span:contains(Russian)')
            .before('<img src="lang/ru.png" alt="" style="width: 20px; height: 15px" />').text('RU');
